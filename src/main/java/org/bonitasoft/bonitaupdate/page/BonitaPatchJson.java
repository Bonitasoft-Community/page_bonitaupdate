...
public class BonitaPatchJson {
    
    public final static String CST_JSON_LOCALPATCHED ="localPatches";

    public final static String CST_JSON_SERVERPATCHES ="serverPatches";
    ...
    public static final String CST_JSON_EXISTREFERENCE = "existreference";
